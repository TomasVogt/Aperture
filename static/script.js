...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function generarRuta() {
        ...
        try {
            ...
            if (!response.ok) {
                const errorData = await response.json().catch(() => ({ error: `Error del servidor: ${response.status}. Intenta ser más específico con tu objetivo.` }));
            ...
            if (!data.fases || data.fases.length === 0) {
                throw new Error("La IA no devolvió una ruta válida. Por favor, reformula tu objetivo.");
            }
            ...
            generateBtn.textContent = '[ Crear Mi Ruta de Aprendizaje ]';
        }
    }
                    ...
                    <div class="step-node">
                        ...
                        <div class="resource-container">
                            ...
                            <div class="alternatives-container">
                                ...
                                <div class="alternative-link-wrapper">
